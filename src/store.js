...
export default new Vuex.Store({
  state: {
    forSale: [
        ...
        { invId: 10, name: 'Jersey Disorder', image: 'src/assets/images/online-store-19.JPG', price: 2000 },
        ...
        { invId: 20, name: 'Jersey White', image: 'src/assets/images/online-store-21.JPG', price: 2000 },
        { invId: 21, name: 'Tomato Soup Jersey', image: 'src/assets/images/online-store-9.JPG', price: 2000 },
